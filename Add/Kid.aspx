<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Kid.aspx.cs" Inherits="Kids" %>
  ...
  <div class='container'>
    <div class='panel panel-primary dialog-panel'>
      <div class='panel-heading'>
        <h5>Adding kid to kindergarten</h5>
      </div>
      <div class='panel-body'>
        <form class='form-horizontal' role='form' runat="server">
          <div class='form-group'>
            <label class='control-label col-md-2 col-md-offset-2' for='id_accomodation'>Kindergarten</label>
            <div class='col-md-2'>
              <div class='form-group internal'>
                    <asp:ListBox ID="ListBox1" CssClass="form-control" runat="server" Rows="1"></asp:ListBox>
                </div>
            </div>
          </div>
          <div class='form-group'>
            ...
            <div class='col-md-8'>
              <div class='col-md-2'>
                <div class='form-group internal'>
                    <asp:ListBox ID="ListBox2" CssClass="form-control" runat="server" Rows="1"></asp:ListBox>
                </div>
              </div>
