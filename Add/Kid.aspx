            ...
            <div class='panel-body'>
                <form class='form-horizontal' role='form' runat="server">
                    ...
                    <div class='form-group'>
                        ...
                        <div class='col-md-1'>
                            <div class='form-group internal'>
                                <asp:TextBox ID="TextBox5" CssClass="form-control" runat="server" placeholder='Number' type="number"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                    <div class='form-group'>
                    ...
                    <div class='form-group'>
                        <div class='col-md-2 col-md-offset-2'>
                            <asp:Button runat="server" class="btn btn-warning btn-fill btn-wd" Style='float: right' Text="Add Kid" type='submit'></asp:Button>
                        </div>
                        <div class='col-md-2'>
