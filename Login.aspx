                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-4 col-sm-6 col-md-offset-4 col-sm-offset-3">
                            <form runat="server" method="#" action="#">
                                ...
                                <div class="card card-hidden">
                                    ...
                                    <div class="content">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox runat="server" ID="loginUsername" type="text" placeholder="Username" class="form-control"></asp:TextBox>
                                        </div>
                                        <div class="form-group">
                                            <label>Password</label>
                                            <asp:TextBox runat="server" ID="loginPassword" type="password" placeholder="Password" class="form-control"></asp:TextBox>
                                        </div>
                                        <div class="form-group">
                                            <label class="checkbox">
                                                <input type="checkbox" data-toggle="checkbox" value="">Remember me
                                            </label>
                                        </div>
                                    </div>
