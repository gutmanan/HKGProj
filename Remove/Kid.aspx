<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Kid.aspx.cs" Inherits="Remove_Kid" %>
                ...
                <form class='form-horizontal' role='form' runat="server">
                    ...
                    <div class='form-group'>
                        ...
                        <div class='col-md-2'>
                            <div class='form-group internal input-group'>
                                <asp:TextBox Enabled="false" runat="server" class='form-control' ID='LongBox' placeholder='Longitude'></asp:TextBox>
                    ...
                    <div class='form-group'>
                        <div class='col-md-2 col-md-offset-2'>
                            <asp:Button runat="server" class="btn btn-warning btn-fill btn-wd" Style='float: right' Text="Remove Kid" type='submit'></asp:Button>
                        </div>
                        <div class='col-md-2'>
